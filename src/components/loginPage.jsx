...
function LoginPage() {
   var text="Login";
   const [newText,ontap]=useState(text);
  ...
  return (
    <Wrapper>
    <div className={`mx-auto  mt-[18%] ${newText=='clicked'?'bg-[#EB002B]':'bg-white'}  rounded-lg w-[100%] lg:w-[50%] h-[63vh] `} >
      ...
      <button class=" mt-[4%] bg-[#EB002B] rounded-[25px] h-[35px] w-[70px] text-[#FFF] font-sans " onClick={onclickHandler}>{newText}</button>
